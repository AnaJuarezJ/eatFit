...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Bebas+Neue"><link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet" />
...
<?php endif; ?>
  ...
  <div class="menu">
    ...
    <div class="login-container">
        <form class="login-form" action="./logica/registrar.php" method="post">
            <h2>Crear Cuenta</h2>
            ...
            <p class="signup-link">¿Ya tienes una cuenta? <a href="login.php">Inicia sesión aquí</a></p>
        </form>
    </div>
